...
# Anitech, Sonoff S26, Sonoff B1, TP-Link HS110, Amazon Echo Dot, Echo Spot and K'Arunan's Echo have different mac address from train_dataset
import numpy as np
...
TRAIN_DATASET = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model0_dataset", "model0_train_paper.csv")
TEST_DATASET = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model0_dataset", "model0_test_paper.csv")
MODEL_NAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model0_dataset", "model0.cbm")
