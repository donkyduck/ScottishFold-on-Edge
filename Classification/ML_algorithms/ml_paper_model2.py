# Machine Learning model 2 (Test w/ some different MAC address.)
...
TEST_DATASET = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model2_dataset", "model2_test_paper.csv")
MODEL_NAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model2_dataset", "model2.cbm")
