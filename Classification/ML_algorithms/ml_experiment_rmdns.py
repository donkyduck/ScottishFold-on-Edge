...
TEST_DATASET = os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiment_dns", "experiment_rmdns.csv")
MODEL_NAME = os.path.join(os.path.dirname(os.path.abspath(__file__)), "experiment_dns", "experiment_rmdns.cbm")
...
plot_confusion_matrix(cm, classes=className,normalize=True,
                      title="Removed DNS packet dataset's confusion matrix")
plt.show()
